...
public class GUIController<T>
{
    ...
    private static final int MIN_DELAY_MSECS = 200, MAX_DELAY_MSECS = 500;
    private static final int INITIAL_DELAY = MIN_DELAY_MSECS
            + (MAX_DELAY_MSECS - MIN_DELAY_MSECS) / 2;

    private Timer timer;
    private JButton stepButton, runButton, stopButton, saveButton, slowStepButton;
    ...
    public void save()
    {
    	...
    	if(System.getProperty("user.name").equals("")){
    		JOptionPane.showMessageDialog(null, "No SaveWorld for ___");
    		System.exit(0);
    	}
    	parentFrame.getWorld().save();
    }
